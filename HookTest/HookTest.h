...
#define HOOKTEST_API __declspec(dllexport)
#else
#define HOOKTEST_API __declspec(dllimport)
#endif

extern "C" HOOKTEST_API void __stdcall NativeInjectionEntryPoint(REMOTE_ENTRY_INFO * remoteInfo);
