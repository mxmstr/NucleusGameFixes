...
//
//    // Assign a custom value to the name field
//    strncpy(name, "DESKTOP-AAAAAAA", namelen - 1);
//    name[namelen - 1] = '\0'; // Ensure null-termination
//    
//    // Log the modified host name
//    Log("Modified Host Name:");
...
//    //std::string randomHostname = "DESKTOP-AAAAAAA";
//    ///*for (int i = 0; i < 5; ++i) {
//    //    randomHostname += '0' + rand() % 10;
//    //}*/
//
//    //Log(randomHostname);
//
//    //// Check if the buffer is large enough to hold the hostname
//    ///*if (namelen < randomHostname.length() + 1) {
//    //    return WSAEFAULT;
//    //}*/
//
//    //// Copy the random hostname to the buffer
//    //strcpy_s(name, namelen, randomHostname.c_str());
//
//    //Log(name);
//
//    return 0;
